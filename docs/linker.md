...
The symbol table contains three parts: IMPORTS, EXPORTS, and LOCALS, which appear in the order
shown in this table:
...
Global symbols (IMPORTS and EXPORTS) are mangled before storage in this table by the assembler.
